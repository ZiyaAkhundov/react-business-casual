        ...
        <section className="page-section">
            <div className="container">
                <div className="product-item">
                    ...
                    <img className="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src={Product01} alt="..." />
                    <div className="product-item-description d-flex me-auto">
                        <div className="bg-faded p-5 rounded"><p class="mb-0">We take pride in our work, and it shows. Every time you order a beverage from us, we guarantee that it will be an experience worth having. Whether it's our world famous Venezuelan Cappuccino, a refreshing iced herbal tea, or something as simple as a cup of speciality sourced black coffee, you will be coming back for more.</p></div>
                    </div>
                </div>
            </div>
        </section>
        <section className="page-section">
            <div className="container">
                <div className="product-item">
                    ...
                    <img className="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src={Product02} alt="..." />
        ...
        <section className="page-section">
            <div className="container">
                <div className="product-item">
                    ...
                    <img className="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src={Product03} alt="..." />
                    <div className="product-item-description d-flex me-auto">
